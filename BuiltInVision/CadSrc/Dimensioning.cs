...
namespace BuiltInVision
{
    ...
    partial class DraftingViewportLayout
    {
        ...
        private void DrawInteractiveLinearDim()
        {
            ...
            DrawText(mouseLocation.X, Height - mouseLocation.Y + 10, dimText,
        ...
        private void DrawInteractiveAngularDim()
        {
            if (selEntityIndex != -1)
            {
                ...
                if (entity is Arc && !drawingAngularDimFromLines)
                {
                    ...
                    DrawText(mouseLocation.X, Height - mouseLocation.Y + 10, dimText, new Font("Tahoma", 8.25f), DrawingColor, ContentAlignment.BottomLeft);
                }
            }
            else if (drawingAngularDimFromLines && quadrantPoint != null)
            {
                ...
                DrawText(mouseLocation.X, Height - mouseLocation.Y + 10, "", new Font("Tahoma", 8.25f), DrawingColor, ContentAlignment.BottomLeft);
            }
        }
