...
public class PowerPmac
{
	...
	[DllImport(dllName)]
	public static extern UInt32 DTKDownloadA(UInt32 uDeviceID, Byte[] lpwDownload, Int32 bDowoload, IntPtr hDownloadWnd, PDOWNLOAD_PROGRESS lpDownloadProgress, PDOWNLOAD_MESSAGE_A lpDownloadMessage);
